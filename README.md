...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/airflow-supervisor-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/airflow-supervisor-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add airflow-supervisor
# for installing globally
pixi global install airflow-supervisor
```
...
It is possible to list all of the versions of `airflow-supervisor` available on your platform:
...
```
pixi search airflow-supervisor --channel conda-forge
```
